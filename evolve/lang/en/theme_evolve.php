...
$string['choosereadme'] = 'Evolve is a child theme of Boost. It needs to behave with Wordpress.';
// Name of the settings pages.
$string['configtitle'] = 'Evolve settings';
...
// We need to include a wordpress header URL.
$string['wordpressheader'] = 'Wordpress header URL';
// We need to include a Wordpress header description.
$string['wordpressheader_desc'] = 'Enter path of Wordpress header';
// We need to include a wordpress header URL.
$string['wordpressfooter'] = 'Wordpress footer URL';
// We need to include a Wordpress header description.
$string['wordpressfooter_desc'] = 'Enter path of Wordpress footer';
